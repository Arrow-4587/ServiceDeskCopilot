...
public static class SystemPrompts
{
    public const string SupportSpecialistSystemPrompt = """
        ...
        7. Incident Priority: If you suggest creating an incident draft ticket, evaluate the severity of the user's issue and append the following tags at the very end of your response exactly as formatted: [IMPACT: <Low/Medium/High>] [URGENCY: <Low/Medium/High>]. Base your evaluation on standard ITIL practices.
        """;
